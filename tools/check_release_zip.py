...
REQUIRED_ENTRY_SUFFIXES = (
    ...
    "web/story_ui/index.html",
    "web/story_ui/assets/videos/daniya_bg.mp4",
    "web/story_ui/assets/fonts/fonts.css",
    "web/story_ui/assets/fonts/barlow-300.ttf",
    "web/story_ui/assets/fonts/barlow-400.ttf",
    "web/story_ui/assets/fonts/barlow-500.ttf",
    "web/story_ui/assets/fonts/barlow-600.ttf",
    "web/story_ui/assets/fonts/barlow-OFL.txt",
    "web/story_ui/assets/fonts/instrument-serif-400.ttf",
    "web/story_ui/assets/fonts/instrument-serif-400-italic.ttf",
    "web/story_ui/assets/fonts/instrument-serif-OFL.txt",
    "web/story_ui/vendor/tailwindcss-3.4.17.js",
    "web/story_ui/vendor/react-18.3.1.production.min.js",
    "web/story_ui/vendor/react-dom-18.3.1.production.min.js",
    "web/story_ui/vendor/babel-7.29.0.min.js",
    "web/story_ui/vendor/licenses/react-LICENSE.txt",
    "web/story_ui/vendor/licenses/tailwindcss-LICENSE.txt",
    "web/story_ui/vendor/licenses/babel-LICENSE.txt",
