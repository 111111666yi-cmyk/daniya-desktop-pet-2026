@echo off
echo [Daniya] Creating desktop shortcut "daniya521"...
...
echo $Shortcut = $WshShell.CreateShortcut([System.IO.Path]::Combine([System.Environment]::GetFolderPath('Desktop'), 'daniya521.lnk')) >> "%TEMP_PS%"
...
echo [Daniya] Shortcut "daniya521" created successfully on your Desktop!
pause
