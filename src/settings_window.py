...
TAB_REGISTRY: list[dict[str, str]] = [
    ...
    {"id": "memory_diary", "title": "记忆与日记", "icon": "document", "mode": "both", "category": "character", "risk_level": "normal", "builder": "_build_memory_diary_tab"},
    {"id": "growth", "title": "养成", "icon": "protect", "mode": "both", "category": "basic", "risk_level": "normal", "builder": "_build_growth_tab"},
    {"id": "environment", "title": "环境与内容", "icon": "cloud", "mode": "both", "category": "basic", "risk_level": "normal", "builder": "_build_environment_tab"},
...
class SettingsWindow(QDialog):
    ...
    def _build_growth_tab(self) -> None:
        ...
        layout.addStretch(1)
        self._register_tab("growth", tab, "protect", "养成")
        self._lazy_tab_loaders["growth"] = self._refresh_growth_status
    ...
    def _build_environment_tab(self) -> None:
        ...
        self._register_tab("environment", tab, "cloud", "环境与内容")
