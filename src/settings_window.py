...
class SettingsWindow(QDialog):
    ...
    def _build_memory_diary_tab(self) -> None:
        ...
        index = self.tabs.addTab(tab, get_icon("document"), "记忆与日记")
        self._register_lazy_tab(index, self._refresh_memory_diary)
    ...
    def _build_environment_tab(self) -> None:
        ...
        self.tabs.addTab(tab, get_icon("cloud"), "环境与内容")
